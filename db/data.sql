...
INSERT INTO person(name, cc_number,cc_validity,address,phone,job,password,department_id) VALUES ('Rita',12131113,'2025-01-01','Rua dos BV',934100200,'Estudante','qwertz',8);
INSERT INTO person(name, cc_number,cc_validity,address,phone,job,password,department_id) VALUES ('Dylan',42222222,'2025-01-02','Rua da Figueira',934300400,'Estudante','qwerty',8);
INSERT INTO person(name, cc_number,cc_validity,address,phone,job,password,department_id) VALUES ('Francisco',45222222,'2025-01-02','Rua da Figueira',934300400,'Estudante','qwerty',8);
