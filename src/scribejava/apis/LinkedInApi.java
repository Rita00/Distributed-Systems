...
public class LinkedInApi extends DefaultApi10a {
    ...
    public static com.github.scribejava.apis.LinkedInApi withScopes(String... scopes) {
        Set<String> scopeSet = new HashSet<String>(Arrays.asList(scopes));
        return new com.github.scribejava.apis.LinkedInApi(scopeSet);
    }
