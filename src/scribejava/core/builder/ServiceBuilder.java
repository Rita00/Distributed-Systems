package scribejava.core.builder;
 ...
 */
public class ServiceBuilder extends AbstractServiceBuilder<com.github.scribejava.core.builder.ServiceBuilder> {

    private Integer connectTimeout;
    private Integer readTimeout;

    public com.github.scribejava.core.builder.ServiceBuilder connectTimeout(final Integer connectTimeout) {
        Preconditions.checkNotNull(connectTimeout, "Connection timeout can't be null");
        this.connectTimeout = connectTimeout;
        return this;
    }

    public com.github.scribejava.core.builder.ServiceBuilder readTimeout(final Integer readTimeout) {
