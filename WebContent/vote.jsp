...
<div id="container" class="container">
    ...
    <div class="rowBtn">
        <div style="margin-right:5%; width:45%" class="fb-share-button"  data-href="http://sd-dylanrita.ddns.net/webser" data-layout="button" data-size="small">
            <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http://sd-dylanrita.ddns.net/webserver;src=sdkpreparse" class="fb button center" style="width: 100%">
