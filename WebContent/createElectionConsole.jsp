...
<body>
    <div id="container" class="container">
        ...
        <form>
            ...
            <label>Descrição
                <textarea class="input" type="text" placeholder="O NEI/AAC (Núcleo de Estudantes de Informática da Associação Académica de Coimbra) é um órgão integrante da AAC que tem o propósito de representar os estudantes de Engenharia Informática e Design e Multimédia da Universidade de Coimbra, sócios da AAC."></textarea>
            </label>
            <label>Tipo<br>
